...
namespace TotalUpdater.Next
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            var providers = new IUpdateSourceProvider[] { new TotalCmdNetSourceProvider(_http), new GhislerSourceProvider(_http), new GitHubReleaseSourceProvider(_http), new GenericHtmlSourceProvider(_http) };
