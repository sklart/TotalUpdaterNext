...
namespace TotalUpdater.Next
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            DataContext = new MainViewModel(resolver, discovery, new UpdateService(catalog, providers, new RemoteCatalogLookup(_http)), catalog, new DownloadService(_http), paths, new TotalUpdater.Next.Core.Installation.CatalogInstallService(providers));
