...
namespace TotalUpdater.Next
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            var discovery = new PluginDiscoveryService(resolver, new LocalVersionResolver(), catalog, null, loadedSettings.Settings);
