...
* Готовая portable-сборка: [`release/TotalUpdater-0.2.1-win7plus.zip`](release/TotalUpdater-0.2.1-win7plus.zip). Внутри один обязательный файл: `TotalUpdater.exe`.
