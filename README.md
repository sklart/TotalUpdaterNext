...
* Готовая portable-сборка: [`release/TotalUpdater-0.3.3-win7plus.zip`](release/TotalUpdater-0.3.3-win7plus.zip). Внутри один обязательный файл: `TotalUpdater.exe`.
